...
“”“Обновить количество коинов пользователя”””
data = load_data()
user_id_str = str(user_id)
...
“”“Зашифровать сообщение в эмодзи”””
text = text.lower()
encrypted = “”
for char in text:
...
“”“Расшифровать сообщение из эмодзи”””
decrypted = “”
...
“”“Создать изображение с турнирной таблицей”””
data = load_data()
users_list = []
...
# Подиум
podium_colors = ['#FFD700', '#C0C0C0', '#CD7F32']  # Золото, Серебро, Бронза
...
for i in range(min(3, len(users_list))):
    ...
    # Имя игрока
    name = users_list[i][0][:12]  # Обрезаем длинные имена
...
async def top_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Команда /top - показать турнирную таблицу"""
    data = load_data()
